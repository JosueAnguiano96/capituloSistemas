...
$qry= "SELECT * FROM conprog_ag17 ORDER BY matricula";
	...
	<body>
		...
		<tr>
			<td colspan='2' align='center'>
				<p>Concurso de Programación 2017</p>
			...
			<tr><td>
				<thead>
					<tr style='background-color:#BAB7B7'>
						...
						<th width='400' height='20'>Carrera</th>
						<th width='400' height='20'>Telefono</th>
						<th width='400' height='20'>Pagado</th>
					</tr>
				</thead>
		...
		while ($registro = mysql_fetch_array($tablaBD)) {
			...
			//echo "<td><a href='updConcurso.php?id=$id'>".$id."</a></td>";
			echo "<td><a href='updConcurso.php?matricula=$matricula'>".$matricula."</a></td>";
			echo "<td>".$nombre."</td>";
			...
			<tr align='center'>
				<td width='1000' align='center'><font color='FF3333'>No existen registros en la tabla de Concurso de Programación 2017!!</font></td>
				</tr>
				</table> 
				";
				echo "
